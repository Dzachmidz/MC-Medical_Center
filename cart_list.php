			...
			<div class="col-lg-8">
				<div class="sticky">
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-md-8"><b>List Product</b></div>
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-4">
									...
									<p class='truncate'> <b><small>Description :
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center">
								<button class="btn btn-block btn-outline-primary" type="button" id="checkout">Continue Ordering</button>
							</div>
						</div>
					</div>
				</div>
